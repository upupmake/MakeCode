...
class TeammateManager:
    ...
    def _sub_agent_loop(self, role: str, prompt: str, log_file: Path) -> dict:
        ...
        sys_prompt = (
            ...
            f"For workspace file read/write/edit, always use File tools (RunRead/RunWrite/RunEdit) first "
            f"and avoid shell-based file manipulation unless absolutely necessary. "
            f"For CLI/build/test/search tasks, use RunTerminalCommand directly. "
